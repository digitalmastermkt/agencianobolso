...
export default function AgenteViral() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      saveGeneration('viral', data.content, formData);
      toast({
        title: "Roteiro viral criado!",
        description: "Seu conteúdo viral foi gerado com sucesso."
      });
    } catch (error) {
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent>
                            <p>Identificação do seu negócio ou marca</p>
                          </TooltipContent>
                        </Tooltip>
                      </div>
                      <Input
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent>
                            <p>O que você quer promover neste vídeo viral?</p>
                          </TooltipContent>
                        </Tooltip>
                      </div>
                      <Input
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent>
                            <p>Cidade/região (ajuda a personalizar o conteúdo)</p>
                          </TooltipContent>
                        </Tooltip>
                      </div>
                      <Input
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent>
                            <p>Quem você quer que compartilhe este conteúdo?</p>
                          </TooltipContent>
                        </Tooltip>
                      </div>
                      <Input
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent>
                            <p>O que torna sua oferta irresistível?</p>
                          </TooltipContent>
                        </Tooltip>
                      </div>
                      <Textarea
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent>
                            <p>Promoção ou diferencial que gera urgência</p>
                          </TooltipContent>
                        </Tooltip>
                      </div>
                      <Input
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <Tooltip>
                          ...
                          <TooltipContent>
                            <p>Escolha o estilo de comunicação para viralizar</p>
                          </TooltipContent>
                        </Tooltip>
                      </div>
