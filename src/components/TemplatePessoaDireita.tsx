...
interface TemplatePessoaDireitaColors {
  background: string;
  headline: string;
  subheadline: string;
...
interface TemplatePessoaDireitaCta {
  label: string;
  href?: string;
  onClick?: () => void;
}

export interface TemplatePessoaDireitaProps {
  photoUrl: string;
  headline: string;
  subheadline: string;
  cta?: TemplatePessoaDireitaCta;
  colors: TemplatePessoaDireitaColors;
  style?: CSSProperties;
}

export function TemplatePessoaDireita({
  photoUrl,
  headline,
  subheadline,
  cta,
